...
describe('App Shell prefetching', () => {
  ...
  describe('navigation()', () => {
    ...
    it('excludes navigation() from a runtime App Shell', async () => {
      ...
      await act(async () => {
        ...
        { includes: 'App shell for navigation', kind: 'runtime' }, // TODO: wait, why are there two requests here?
      ])
  ...
  describe('prefetch()', () => {
    ...
    it('excludes prefetch() from a runtime App Shell', async () => {
      ...
      // deopts to runtime requests: first the Shell phase's runtime App Shell
      // request, then the Speculative phase's batched per-link prefetch.
      await act(async () => {
        await browser
