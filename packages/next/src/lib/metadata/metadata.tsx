...
import type { MetadataErrorType, SelectedMetadata } from './resolve-metadata'
import type { ResolvedViewport } from './types/metadata-interface'
import type { MetadataContext } from './types/resolvers'
import { createServerSearchParamsForMetadata } from '../../server/request/search-params'
import { createServerPathnameForMetadata } from '../../server/request/pathname'
import { createLegacyMetadataComponents } from './metadata-legacy'
import { createParallelMetadataComponents } from './metadata-parallel'
...
export function createMetadataComponents({
  ...
  if (parallelRouteMetadata) {
    return createParallelMetadataComponents({
      tree,
      pathname: pathnameForMetadata,
      searchParams,
      metadataContext,
      interpolatedParams,
      errorType,
  ...
  return createLegacyMetadataComponents({
    tree,
    pathname: pathnameForMetadata,
    searchParams,
    metadataContext,
