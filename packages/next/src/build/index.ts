      ...
      if (
        ...
        await staticGenerationSpan.traceAsyncFn(async () => {
          ...
          const getFallbackMode = (route: PrerenderedRoute) => {
            // The key is the written path, because the shell of a combination
            // was exported to its own prefixed path. A question about the route
            // would report on whichever combination was written there.
